...
For the UI I put in the canvas and chose a random sprite that was already in the engine as the image.  I got the button and title working, but I couldn't figure out for the life of me how to turn off the canvas to play the game.
